...
export default {
  ...
  async changeUserRole(payload) {
    try {
      const response = await api.post("/api/access/roles/change/", payload);
  ...
  async removeUserRole(payload) {
    try {
      const response = await api.post("/api/access/roles/remove/", payload);
      return response.data;
    } catch (error) {
  ...
  async viewRoleHistory(params = {}) {
    try {
      const response = await api.get("/api/access/roles/history/", { params });
      return response.data;
    } catch (error) {
  ...
  async createRoleInvite(payload) {
    try {
      const response = await api.post("/api/access/invites/create/", payload);
      return response.data;
    } catch (error) {
  ...
  async listRoleInvites(params = {}) {
    try {
      const response = await api.get("/api/access/invites/", { params });
      return response.data;
    } catch (error) {
  ...
  async resendRoleInvite(inviteId) {
    try {
      const response = await api.post(
        `/api/access/invites/${inviteId}/resend/`
      );
      return response.data;
    } catch (error) {
  ...
  async acceptRoleInvite(payload) {
    try {
      const response = await api.post("/api/access/invites/accept/", payload);
      return response.data;
    } catch (error) {
  ...
  async acceptRoleInviteByToken(token) {
    try {
      const response = await api.get(`/api/access/invites/accept/${token}/`);
      return response.data;
    } catch (error) {
  ...
  async declineRoleInvite(payload) {
    try {
      const response = await api.post("/api/access/invites/decline/", payload);
      return response.data;
    } catch (error) {
