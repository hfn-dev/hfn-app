    ...
    partners: {
      ...
      fields: {
        ...
        logos: {
          ...
          default: ["pharm", "society", "bridge", "emzor", "hba"],
        },
      },
    },
    ...
    story: {
      ...
      fields: {
        title: {
          type: "text",
          label: "Title",
          default: "Our HFN Story",
        },
        body: {
          type: "textarea",
          label: "Story Content",
          default:
            "The Healthcare Federation of Nigeria (HFN) is the umbrella body...",
        },
        stats: {
          type: "array",
          label: "Statistics",
        ...
        executivesList: {
          ...
          item: {
            ...
            fields: {
              ...
              image: { type: "image", label: "Profile Image" },
            },
          },
          default: [
            {
      ...
      fields: {
        faqList: {
          ...
          default: [
            {
              question:
                "What paves the Healthcare Federation of Nigeria (HFN) on?",
              answer:
                "HFN is paved on the mission to provide a unified voice...",
            },
          ],
        },
      },
            ...
            fields: {
              ...
              featured: {
                ...
                fields: {
                  ...
                  comments: { type: "number", label: "Comment Count" },
                  description: {
                    type: "textarea",
                    label: "Description",
                  },
