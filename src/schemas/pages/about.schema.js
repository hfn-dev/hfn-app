export const aboutPageSchema = {
  ...
  roleSection: {
    ...
    tags: ['Policymakers', 'Regulators', 'Investors', 'Partners'],
    tagDescription:
  ...
  history: {
    ...
    subtitle: 'A Coordinated Platform for Policy Engagement & System Reform',
  },

  governance: {
    title: 'Governance & Leadership',
    note: 'This structure ensures accountability and effective execution of HFN’s mandate, while reflecting the diversity of Nigeria’s private health sector.',
    units: [
      'Board of Trustees',
