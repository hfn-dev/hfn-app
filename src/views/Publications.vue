  ...
  <div class="publications-page font-sans bg-gray-50 min-h-screen">
        ...
        <div class="flex flex-col lg:flex-row items-center justify-between">
          <div class="lg:w-1/2 mb-8 lg:mb-0">
            ...
            <p class="mt-4 text-gray-600 max-w-lg text-lg">
              Access our latest research papers, annual reports, and industry
              insights. Stay informed with our curated collection of
              downloadable documents.
            </p>
          </div>
          <div class="lg:w-1/3 hidden lg:block">
            <div
              class="p-8 bg-green-50 rounded-2xl border-2 border-dashed border-green-200 flex flex-col items-center"
            >
              <svg
                class="w-20 h-20 text-green-700 mb-4"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
      ...
      <div class="container mx-auto px-4 md:px-8 py-6">
        <div class="flex flex-col md:flex-row gap-4 items-center">
          ...
          <div class="flex gap-3 w-full md:w-auto">
            <select
              class="flex-1 md:w-32 p-3 border border-gray-300 rounded-lg bg-white"
            >
              <option>Year</option>
              <option>2026</option>
              <option>2025</option>
            ...
            <select
              class="flex-1 md:w-40 p-3 border border-gray-300 rounded-lg bg-white"
            >
            ...
            <button
              class="bg-green-700 text-white px-6 py-3 rounded-lg hover:bg-green-800 transition font-semibold"
            >
              Filter
            </button>
          </div>
    ...
    <section class="container mx-auto px-4 md:px-8 py-12">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        >
          <div
            class="relative h-48 bg-gray-100 rounded-t-xl overflow-hidden group"
          >
            <img
            ...
            >
              <span
                class="bg-white/90 px-4 py-2 rounded-md shadow-sm text-sm font-bold text-gray-700 uppercase"
              >
                {{ doc.fileType }}
              </span>
            </div>
...
const publications = [
  {
    ...
    fileSize: "4.2 MB",
    description:
      "A comprehensive review of our community projects, financial growth, and strategic milestones achieved over the last fiscal year.",
  ...
  },
  {
    ...
    fileSize: "1.8 MB",
    description:
      "Exploring the shift in digital infrastructure across emerging markets and its impact on small businesses.",
  ...
  },
  {
    ...
    fileSize: "850 KB",
    description:
      "Step-by-step documentation on the implementation of youth-led innovation hubs in local communities.",
