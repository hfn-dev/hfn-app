    ...
    <div class="get-involved-page font-sans bg-white">
                ...
                <div class="flex flex-col lg:flex-row items-start lg:items-center justify-between">
                    ...
                    <div class="lg:w-1/2 mb-8 lg:mb-0">
                        ...
                        <p class="mt-4 text-gray-600 max-w-lg">
                            Eutemod magna id purus eget nunc ligula suspendisse dal netus. Condimentum blandit nistrem at mauris enim pulvinar duie etset duls. Euismod magna id purus eget nunc.
                        </p>
                    </div>
        ...
        <main class="container mx-auto px-4 md:px-8 py-16">
            ...
            <section class="mb-20">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="border rounded-lg p-6 shadow-md bg-white hover:shadow-xl transition duration-300">
                        ...
                        <p class="text-gray-600 text-sm mb-6 h-32 overflow-hidden">
            ...
            <section>
                ...
                <p class="text-gray-600 mb-4 max-w-4xl">
                    Euismod magna id purus eget nunc ligula suspendisse dul netus. Condimentum blandit rutrum at mauris enim pulvinar duis etiam duis. Euismod magna id purus eget nunc.
                </p>
                <p class="text-gray-600 mb-8 max-w-4xl">
