...
const activeCourses = computed(() => {
  if (currentTab.value === "Registration") return registration.value;
  if (currentTab.value === "Purchases") return purchases.value;
  return [];
});
