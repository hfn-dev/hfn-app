<template>
  <div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 font-sans">
    <div
      class="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100"
    >
      <div class="bg-green-700 p-8 text-white">
        <h1 class="text-3xl font-bold">2026 HFN Annual Conference</h1>
        <p class="mt-2 text-green-100 italic">
          Healthcare Federation of Nigeria (HFN) Event Registration
        </p>
      </div>
      ...
      <form @submit.prevent="handleSubmit" class="p-8 space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              class="mt-1 block w-full px-4 py-3 border border-gray-300 rounded-lg bg-white"
            >
        ...
        <div
          class="bg-gray-50 p-4 rounded-xl flex items-center justify-between border border-gray-200"
        >
          <div class="flex items-center">
            ...
            <label
              for="is_free"
              class="ml-3 block text-sm font-bold text-gray-700"
              >I'm a member</label
            >
          </div>
